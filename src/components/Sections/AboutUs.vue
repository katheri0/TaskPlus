<template>
  <section id="about-Us" class="py-32 bg-[#fafafa] rounded-[2rem] flex justify-center">
    <div class="w-full max-w-4xl mx-auto px-6 flex flex-col items-center text-center">
